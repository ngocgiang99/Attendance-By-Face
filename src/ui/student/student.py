...
class Ui_StudentWidget(object):
    def setupUi(self, StudentWidget):
        ...
        self.view_attendance_history = QPushButton(self.gridLayoutWidget)
        self.view_attendance_history.setObjectName(u"view_attendance_history")
        sizePolicy = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.view_attendance_history.sizePolicy().hasHeightForWidth())
        self.view_attendance_history.setSizePolicy(sizePolicy)

        self.utilities_button.addWidget(self.view_attendance_history, 0, 2, 1, 1)

        self.update_face_id = QPushButton(self.gridLayoutWidget)
        self.update_face_id.setObjectName(u"update_face_id")
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Expanding)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.update_face_id.sizePolicy().hasHeightForWidth())
        self.update_face_id.setSizePolicy(sizePolicy1)

        self.utilities_button.addWidget(self.update_face_id, 0, 0, 2, 1)

        self.attendance = QPushButton(self.gridLayoutWidget)
        self.attendance.setObjectName(u"attendance")
        sizePolicy1.setHeightForWidth(self.attendance.sizePolicy().hasHeightForWidth())
        self.attendance.setSizePolicy(sizePolicy1)

        self.utilities_button.addWidget(self.attendance, 0, 1, 2, 1)
    ...
    def retranslateUi(self, StudentWidget):
        ...
        self.view_attendance_history.setText(QCoreApplication.translate("StudentWidget", u"Xem l\u1ecbch s\u1eed \u0111i\u1ec3m danh", None))
        self.update_face_id.setText(QCoreApplication.translate("StudentWidget", u"C\u1eadp nh\u1eadt khu\u00f4n m\u1eb7t", None))
        self.attendance.setText(QCoreApplication.translate("StudentWidget", u"\u0110i\u1ec3m danh", None))
